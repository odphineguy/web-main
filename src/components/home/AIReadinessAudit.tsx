...
const copy: Record<"en" | "es", AuditCopy> = {
  en: {
    ...
    lede: "Answer five questions. Get a practical opportunity score and a one-page plan for the first workflow worth building.",
    time: "60–90 seconds",
    checks: "checks",
    ...
    levels: {
      foundation: { label: "Emerging opportunity", title: "Start with one controlled handoff.", summary: "Your operation has a solid base. The best first move is a narrow workflow that saves staff time without disrupting what already works." },
      ready: { label: "Strong opportunity", title: "Your calls are ready for automation.", summary: "A focused AI intake workflow can cover your biggest gaps now, then expand once the handoff is proven." },
      priority: { label: "Immediate opportunity", title: "Revenue is leaking through the phone.", summary: "Your answers show repeated coverage and intake gaps. An AI receptionist can create an immediate operating layer around every inbound call." },
    },
    ...
    captureTitle: "Send me the one-page action plan",
    captureBody: "Get your findings, first workflow, 30-day rollout, success measures, and a print-ready PDF version.",
    name: "Full name",
    email: "Work email",
    phone: "Phone number",
    consent: "By submitting, you agree that Abe Media may contact you about your audit. No automated sales blasts.",
    send: "Email my action plan",
    sending: "Sending audit…",
    sent: "Audit delivered.",
    sentBody: "Check your inbox for the full plan and a link you can save as a PDF. Abe also received your answers so any follow-up starts with context.",
  ...
  es: {
    ...
    lede: "Responde cinco preguntas. Recibe tu puntuación de oportunidad y un plan de una página para el primer flujo que vale la pena construir.",
    time: "60–90 segundos",
    checks: "puntos",
    ...
    levels: {
      foundation: { label: "Oportunidad inicial", title: "Empieza con un handoff controlado.", summary: "Tu operación tiene una buena base. El mejor primer paso es un flujo específico que ahorre tiempo sin interrumpir lo que ya funciona." },
      ready: { label: "Oportunidad clara", title: "Tus llamadas están listas para IA.", summary: "Un flujo de intake con IA puede cubrir tus huecos principales y crecer después de comprobar el handoff." },
      priority: { label: "Oportunidad inmediata", title: "El teléfono está dejando escapar ingresos.", summary: "Tus respuestas muestran huecos repetidos de cobertura e intake. Un recepcionista con IA puede crear una capa operativa para cada llamada." },
    },
    ...
    captureTitle: "Envíame el plan de acción de una página",
    captureBody: "Recibe tus hallazgos, el primer flujo, un lanzamiento de 30 días, métricas y una versión lista para guardar como PDF.",
    name: "Nombre completo",
    email: "Correo de trabajo",
    phone: "Número de teléfono",
    consent: "Al enviar, aceptas que Abe Media te contacte sobre tu auditoría. No enviamos blasts automatizados.",
    send: "Enviar mi plan de acción",
    sending: "Enviando auditoría…",
    sent: "Auditoría entregada.",
    sentBody: "Revisa tu inbox para ver el plan completo y un enlace que puedes guardar como PDF. Abe también recibió tus respuestas para dar seguimiento con contexto.",
