...
const categoryColors: Record<string, { bg: string; text: string; border: string; hover: string }> = {
  ...
  "AI Marketing": { 
    ...
    hover: "hover:border-neutral-400 dark:hover:border-neutral-500"
  },
  "Chatbot Development": { 
    bg: "bg-neutral-100 dark:bg-neutral-800", 
    text: "text-neutral-700 dark:text-neutral-300",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-neutral-900 dark:text-white mb-6">
              Bilingual Marketing &
              <span className="text-orange-500"> AI Resources</span>
            </h1>
              ...
              {featuredPages.map((page) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold text-neutral-900 dark:text-white mb-3 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors line-clamp-2">
                      {page.title}
                    </h3>
