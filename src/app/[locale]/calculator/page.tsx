      ...
      <section className="px-6 pb-12">
        ...
        >
          <div className="text-center p-6 rounded-xl bg-gray-50 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800">
            ...
            <p className="text-sm text-gray-600 dark:text-neutral-400">{t("stats.hispanicPopulation")}</p>
          </div>
          <div className="text-center p-6 rounded-xl bg-gray-50 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800">
            <p className="text-3xl font-bold text-gray-900 dark:text-white mb-1">
              <AnimatedCounter target={41} suffix="M" duration={1200} />
            </p>
            <p className="text-sm text-gray-600 dark:text-neutral-400">{t("stats.spanishSpeakers")}</p>
          </div>
          <div className="text-center p-6 rounded-xl bg-gray-50 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800">
            <p className="text-3xl font-bold text-gray-900 dark:text-white mb-1">
              <AnimatedCounter target={2.8} prefix="$" suffix="T" duration={1200} decimals={1} />
            </p>
            <p className="text-sm text-gray-600 dark:text-neutral-400">{t("stats.buyingPower")}</p>
          </div>
        </motion.div>
      </section>
