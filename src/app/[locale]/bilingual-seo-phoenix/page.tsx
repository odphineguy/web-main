    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="px-6 pt-20 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-[32px] md:text-[36px] lg:text-[40px] font-medium tracking-[-0.02em] text-foreground mb-6">
            Bilingual SEO for{" "}
            <span className="text-primary">
              Phoenix Local Businesses
            </span>
          </h1>
          <p className="text-[14px] md:text-[16px] font-normal leading-[1.5] text-muted-foreground mb-8 max-w-2xl">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-primary hover:bg-primary/90 text-white text-[14px] font-medium rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
          >
      ...
      <section className="px-6 py-16 bg-gray-50 dark:bg-neutral-900">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-[32px] md:text-[36px] lg:text-[40px] font-medium tracking-[-0.02em] text-foreground mb-4 text-center">
            Why Bilingual SEO Matters in{" "}
            <span className="text-primary">
              Phoenix
            </span>
          </h2>
          <p className="text-center text-[14px] md:text-[16px] font-normal leading-[1.5] text-muted-foreground mb-10 max-w-2xl">
            Many Spanish-speaking users actively search for local services in Spanish, yet few businesses are optimized to reach them.
          </p>

          {/* Stat Callout */}
          <div className="bg-primary rounded-2xl p-8 mb-10 text-center text-white">
      ...
      <section className="px-6 py-16">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl">
            <div className="bg-card border border-border rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-medium text-foreground">English Search</span>
              </div>
              <p className="text-lg font-mono text-foreground bg-gray-100 dark:bg-neutral-900 px-4 py-3 rounded-lg">
            ...
            <div className="bg-card border border-border rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-medium text-foreground">Spanish Search</span>
              </div>
              <p className="text-lg font-mono text-foreground bg-gray-100 dark:bg-neutral-900 px-4 py-3 rounded-lg">
          ...
          <p className="text-center text-[14px] md:text-[16px] font-normal leading-[1.5] text-muted-foreground mt-8">
      ...
      <section className="px-6 py-16 bg-gray-50 dark:bg-neutral-900">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-[14px] md:text-[16px] font-normal leading-[1.5] text-muted-foreground mb-12 max-w-2xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-card rounded-2xl p-6 border border-border">
              ...
              <h3 className="text-[20px] md:text-[24px] font-normal tracking-[0em] text-foreground mb-3">
                Language-Specific Strategy
              </h3>
      ...
      <section className="px-6 py-16">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-[14px] md:text-[16px] font-normal leading-[1.5] text-muted-foreground mb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              <div
                key={index}
                className="flex flex-col items-center gap-3 p-5 bg-gray-50 dark:bg-neutral-800 rounded-xl border border-border hover:border-orange-500/50 transition-colors"
              >
      ...
      <section className="px-6 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-[32px] md:text-[36px] lg:text-[40px] font-medium tracking-[-0.02em] text-foreground mb-4">
            Serving Phoenix and{" "}
            <span className="text-primary">
              Surrounding Areas
            </span>
          </h2>
          <p className="text-[14px] md:text-[16px] font-normal leading-[1.5] text-muted-foreground mb-8">
