...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return constructMetadata({ title: data.metaTitle, description: data.description, path: `/industries/${slug}`, locale, hasSpanishEquivalent: false });
}
...
export default async function IndustryDetailPage({ params }: Props) {
  ...
  return <DiscoverabilityPage data={data} path={`/en/industries/${slug}`} />;
}
