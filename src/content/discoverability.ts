...
export const servicePages: Record<string, ContentPageData> = {
  ...
  "dispatch-operations-software": {
    slug: "dispatch-operations-software",
    kind: "service",
    ...
    intro: "Abe Media builds custom dispatch and operations systems for teams coordinating drivers, crews, jobs, customers, and exceptions. The work is grounded in Abe Perez's 17 years at Waste Management—not a generic dashboard template.",
    ...
    faqs: [
      { question: "Do we have to replace every system at once?", answer: "No. A focused system can sit beside existing tools, replace one brittle workflow, and expand only when the pilot proves useful." },
    ...
    related: [
      ...
      { href: "/en/portfolio/saguarotransport", label: "Saguaro Transport", description: "A production transportation system case study." },
    ],
  },
  "lead-pipeline-automation": {
    ...
    title: "Move a lead from first message to booked job—without dropping a handoff",
    ...
    proofTitle: "See the system behind a live lead-to-job workflow",
    proof: "Abe Media's How It Works page breaks down a live Phoenix moving and junk-removal workflow—from intake through quoting, booking, CRM, and exception handling—without exposing customer data or private operating rules.",
    faqs: [
      { question: "Can you automate leads from marketplaces?", answer: "Yes, when the lead source provides an authorized integration or webhook. The design should preserve attribution and avoid unsupported scraping or fragile browser tricks." },
    ...
    related: [
      { href: "/en/how-it-works", label: "See the workflow", description: "Follow the lead-to-finished-job pipeline." },
  ...
  "custom-business-software": {
    ...
    related: [
      { href: "/en/portfolio/saguarotransport", label: "Saguaro Transport build", description: "See the operations platform built for a transportation company." },
...
export const industryPages: Record<string, ContentPageData> = {
  "logistics-transportation": {
    ...
    ], proofTitle: "Relevant production work", proof: "Saguaro Transport and Rejunk demonstrate two different transportation and field-operation patterns: a full transportation operations system and a browser-based dispatch/driver workflow.", faqs: [
    ...
    ], related: [{ href: "/en/services/dispatch-operations-software", label: "Custom dispatch systems", description: "See the service and delivery model." }, { href: "/en/portfolio/saguarotransport", label: "Saguaro Transport", description: "Review a transportation operations system case study." }, contact],
  },
  "junk-removal": {
