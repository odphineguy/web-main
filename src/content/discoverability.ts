...
export const servicePages: Record<string, ContentPageData> = {
  ...
  "custom-business-software": {
    ...
    related: [
      { href: "/en/systems-we-build", label: "Systems we have built", description: "See software built for transportation and home-service operations." },
