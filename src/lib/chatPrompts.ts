...
export const SYSTEM_INSTRUCTION_EN = `You are Ashlee, a helpful customer support chatbot for Abe Media.
...
export const SYSTEM_INSTRUCTION_ES = `Eres Ashlee, una asistente virtual de atención al cliente para Abe Media.
...
export const getInitialMessage = (lang: 'en' | 'es' = 'en') =>
  lang === 'es' ? INITIAL_MESSAGE_ES : INITIAL_MESSAGE_EN;

export const getSystemInstruction = (lang: 'en' | 'es' = 'en') =>
  lang === 'es' ? SYSTEM_INSTRUCTION_ES : SYSTEM_INSTRUCTION_EN;
